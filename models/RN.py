...
class RN_B(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        rn_x_foreground = (
            rn_x * mask) * (1 + self.foreground_gamma[None, :, None, None]) + self.foreground_beta[None, :, None, None]
...
class saRN_ResnetBlock(nn.Module):
    def __init__(self, dim, dilation, threshold, use_spectral_norm=True):
        ...
        self.conv_block = nn.Sequential(
            ...
            spectral_norm(nn.Conv2d(in_channels=dim, out_channels=256, kernel_size=3,
            ...
            spectral_norm(nn.Conv2d(in_channels=256, out_channels=dim, kernel_size=3,
...
class RN(nn.Module):
    def __init__(self, input_channels=3, residual_blocks=8, threshold=0.8):
        ...
        self.encoder_conv1 = nn.Conv2d(
            in_channels=input_channels, out_channels=64, kernel_size=7, padding=0)
        ...
        for _ in range(residual_blocks):
            ...
            block = saRN_ResnetBlock(
                256, dilation=2, threshold=threshold, use_spectral_norm=False)
            blocks.append(block)
        ...
        self.decoder = nn.Sequential(
            ...
            nn.Conv2d(in_channels=64, out_channels=input_channels,
