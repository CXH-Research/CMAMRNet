...
class DeepFillV2(nn.Module):
    def __init__(self, in_channels=4, latent_channels=48, out_channels=3, pad_type='zero', activation='elu', norm='none'):
        ...
        self.coarse = nn.Sequential(
            ...
            GatedConv2d(latent_channels, latent_channels * 2, 3, 2, 1,
                        pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels * 2, latent_channels * 2, 3, 1,
                        1, pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels * 2, latent_channels * 4, 3, 2,
                        1, pad_type=pad_type, activation=activation, norm=norm),
            # Bottleneck
            GatedConv2d(latent_channels * 4, latent_channels * 4, 3, 1,
                        1, pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels * 4, latent_channels * 4, 3, 1,
                        1, pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels * 4, latent_channels * 4, 3, 1, 2,
                        dilation=2, pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels * 4, latent_channels * 4, 3, 1, 4,
                        dilation=4, pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels * 4, latent_channels * 4, 3, 1, 8,
                        dilation=8, pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels * 4, latent_channels * 4, 3, 1, 16,
                        dilation=16, pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels * 4, latent_channels * 4, 3, 1,
                        1, pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels * 4, latent_channels * 4, 3, 1,
                        1, pad_type=pad_type, activation=activation, norm=norm),
            # decoder
            TransposeGatedConv2d(latent_channels * 4, latent_channels * 2, 3,
                                 1, 1, pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels * 2, latent_channels * 2, 3, 1,
                        1, pad_type=pad_type, activation=activation, norm=norm),
            TransposeGatedConv2d(latent_channels * 2, latent_channels, 3, 1,
                                 1, pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels, latent_channels//2, 3, 1, 1,
                        pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels//2, out_channels, 3, 1,
                        1, pad_type=pad_type, activation='none', norm=norm),
            nn.Tanh()
        )
        ...
        self.refine_conv = nn.Sequential(
            ...
            GatedConv2d(latent_channels, latent_channels*2, 3, 1, 1,
                        pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels*2, latent_channels*2, 3, 2, 1,
                        pad_type=pad_type, activation=activation, norm=norm),
        ...
        self.refine_atten_1 = nn.Sequential(
            ...
            GatedConv2d(latent_channels, latent_channels*2, 3, 1, 1,
                        pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels*2, latent_channels*4, 3, 2, 1,
                        pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels*4, latent_channels*4, 3, 1, 1,
                        pad_type=pad_type, activation=activation, norm=norm),
            GatedConv2d(latent_channels*4, latent_channels*4, 3, 1,
                        1, pad_type=pad_type, activation='relu', norm=norm)
        )
